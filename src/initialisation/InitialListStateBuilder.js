 ...
 */
class InitialListStateBuilder extends InitialStateBuilder {
   ...
   * @param {ResourceStatus} options.status The status to use for the list and all of its items if
   *        the list hasn't set its own.
   * @param {ResourceMetadata} options.metadata The metadata to use for the list and all of its
   *        items if the list hasn't set its own.
   * @returns {ResourcesList} The initial list state
   */
   ...
   * @param {Object} options Options hash
   * @param {ResourceStatus} options.status The status to use for the items if the list or item hasn't
   *        set its own.
   * @param {ResourceMetadata} options.metadata The metadata for the items if the list or item
   *        hasn't set its own.
...
export default InitialListStateBuilder;
