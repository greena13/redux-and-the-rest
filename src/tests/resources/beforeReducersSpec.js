...
describe('beforeReducers option:', function () {
  beforeAll(function () {
  ...
  describe('Given a beforeReducers option is provided when defining a resource', () => {
    describe('and the API request succeeds', function () {
      describe('before the request has completed', function () {
        ...
        it('then calls the beforeReducers', function () {
      ...
      describe('when the request has completed', () => {
        ...
        it('then calls the beforeReducers', function () {
          expect(resourcesItem(this, RESOURCE_NAME, '1').status.afterRequest).toEqual(true);
        });
