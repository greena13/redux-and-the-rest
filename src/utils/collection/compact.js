...
/**
 * Removes undefined and null values from collections. When passed an array, it returns a new array
 ...
 * @param {Array|Object} target The collection to remove empty values from
 * @param {Array} [emptyValues=[undefined, null]] List of values to consider empty}
 * @returns {Array|Object} A new collection with the empty values removed
 */
